...
public class JedisUtils {
	...
	public static String listPop(String key){
		...
		try {
			...
			logger.debug("listPop {} = {}", key);
		} catch (Exception e) {
			logger.warn("listPop {} = {}", key,e);
		} finally {
			returnResource(jedis);
		}
		return result;
	...
	public static Jedis getResource() throws JedisException {
		Jedis jedis = null;
		try {
			JedisSentinelPool jedisPool = SpringContextHolder.getBean(JedisSentinelPool.class);
	...
	public static Jedis getResourceM() throws JedisException {
		Jedis jedis = null;
		try {
			JedisSentinelPool jedisPool = SpringContextHolder.getBean(JedisSentinelPool.class);
			jedis = jedisPool.getResource();
	...
	public static void returnResourceM(Jedis jedis) {
		if (jedis != null) {
			JedisSentinelPool jedisPool = SpringContextHolder.getBean(JedisSentinelPool.class);
